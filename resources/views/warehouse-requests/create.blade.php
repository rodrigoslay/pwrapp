...
@section('title', 'Crear Solicitud de Almacén | Dashboard')

@section('content_header')
    <h1>Crear Solicitud de Almacén</h1>
@stop
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="status" value="{{ old('status', 'pending') }}">
                    </div>
                </div>
