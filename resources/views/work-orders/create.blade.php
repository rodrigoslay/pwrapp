                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control" name="discount_percentage" value="{{ old('discount_percentage') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control" name="discount_amount" value="{{ old('discount_amount') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control" name="subtotal" value="{{ old('subtotal') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control" name="tax" value="{{ old('tax') }}" required>
                                @if($errors->has('tax'))
                            ...
                            <div class="form-group">
                                ...
                                <select name="review" class="form-control" required>
                                    <option value="0" {{ old('review') == 0 ? 'selected' : '' }}>No</option>
                                    <option value="1" {{ old('review') == 1 ? 'selected' : '' }}>Sí</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="executive_id" value="{{ old('executive_id') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="mechanic_id" value="{{ old('mechanic_id') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="vehicle_id" value="{{ old('vehicle_id') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="entry_mileage" value="{{ old('entry_mileage') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="exit_mileage" value="{{ old('exit_mileage') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control" required>
                                    ...
                                    <option value="Comenzó" {{ old('status') == 'Comenzó' ? 'selected' : '' }}>Comenzó</option>
                                    <option value="Incidencias Reportadas" {{ old('status') == 'Incidencias Reportadas' ? 'selected' : '' }}>Incidencias Reportadas</option>
                                    <option value="Incidencias Aprobadas" {{ old('status') == 'Incidencias Aprobadas' ? 'selected' : '' }}>Incidencias Aprobadas</option>
                                    <option value="Completado" {{ old('status') == 'Completado' ? 'selected' : '' }}>Completado</option>
                                    <option value="Facturado" {{ old('status') == 'Facturado' ? 'selected' : '' }}>Facturado</option>
